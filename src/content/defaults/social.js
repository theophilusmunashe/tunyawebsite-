...
export const social = {
  ...
  channels: [
    { network: "facebook", name: "Facebook", handle: "@tunyafrika", body: "Awareness posts, travel tips and everything you need to know before you fly.", href: "https://www.facebook.com/tunyafrika" },
    { network: "instagram", name: "Instagram", handle: "@tunyafrika", body: "The gallery — rainbows, elephants, golden hour and guest photographs.", href: "https://www.instagram.com/tunyafrika" },
    ...
    { network: "tiktok", name: "TikTok", handle: "@tunyafrika", body: "The bungee jumps, the drum circles, the faces the moment the spray hits.", href: "https://www.tiktok.com/@tunyafrika" }
  ],
  tunyaCard: {
