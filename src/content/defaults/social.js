...
export const social = {
  ...
  channels: [
    ...
    { network: "instagram", name: "Instagram", handle: "@tunyafrika_xperience", body: "The gallery — rainbows, elephants, golden hour and guest photographs.", href: "https://www.instagram.com/tunyafrika_xperience" },
